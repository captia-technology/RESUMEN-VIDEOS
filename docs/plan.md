...
- macOS: no se ha ejecutado `video.py` ni las pruebas automáticas, ni se han comprobado las órdenes de `brew` de la [guía de instalación](instalacion.md#1-requisitos-previos).
